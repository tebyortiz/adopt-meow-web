    ...
    <div>
      ...
      <div className="flex flex-col items-center px-4 pt-24 pb-12 text-white">
        ...
        >
          ...
          <p className="md:text-xl font-light font-fredoka md:text-left text-center mt-4 md:px-0 px-6">
            AdoptMeow es una plataforma dedicada a conectar a gatitos sin hogar
            con personas dispuestas a brindarles un nuevo hogar lleno de amor.
            Nos aseguramos de que cada adopción sea responsable y segura,
        ...
        <div className="flex flex-col md:flex-row md:items-start w-full md:max-w-5xl mx-auto md:mb-56 mb-24 ">
          ...
          >
            ...
            <p className="md:text-xl text-white font-fredoka font-light md:w-5/6 md:text-left text-center">
              Únete a nuestra maravillosa comunidad y ayuda a cambiar la vida de
              un gatito. Cada miembro cuenta y tu participación es esencial para
              que más gatitos encuentren un hogar lleno de amor. ¡Regístrate y
              sé parte del cambio!
            </p>
          </motion.div>
